              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone">House Rent</th>
                    <th class="hidden-phone">Paid Rent</th>
                    <th class="hidden-phone">Date Paid</th>
                  </tr>
                </thead>
                <?php
                    $aid=$_SESSION['id'];
                ...
                <tbody>
                  ...
                  <td><img src="../client/img/profile_pic/<?php echo $row->pic;?>" class="img-rectangle" width="100"></td>
                    ...
                    <td class="center hidden-phone">Ksh <?php echo $row->creditrent;?></td>
                    <td class="center hidden-phone">Ksh <?php echo $row->debitrent;?></td>
                    <td class="center hidden-phone"><?php echo $row->datepaid;?></td>
                  </tr>
