...
{
	$id=intval($_GET['del']);
	$adn="delete from house where id=?";
		$stmt= $mysqli->prepare($adn);
		$stmt->bind_param('i',$id);
        $stmt->execute();
        $stmt->close();	   
        echo "<script>alert('House Details Successfully Deleted');</script>" ;
}
?>
   ...
   <?php include("includes/navbar.php")?>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <h3><i class="fa fa-cogs"></i> Manage Houses</h3>
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                    <a href='admin-view-single-house.php?id=<?php echo $row->id;?>'><button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button></a>
                     <a href='admin-edit-single-house.php?id=<?php echo $row->id;?>'><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                      <a href='admin-manage-house.php?del=<?php echo $row->id;?>' onClick= "return confirm("Do you want to delete");"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                    </td>
                  </tr>              
